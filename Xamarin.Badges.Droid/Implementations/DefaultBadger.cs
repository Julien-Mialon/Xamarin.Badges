...
internal class DefaultBadger : BaseIntentBadger
{
	...
	public override string[] SupportedLaunchers => ["fr.neamar.kiss", "com.quaap.launchtime", "com.quaap.launchtime_official"];
	...
	public static bool IsSupported(Context context)
	{
		return BroadcastHelper.CanResolveBroadcast(context, new Intent(Constants.DEFAULT_INTENT_ACTION))
		       || (Build.VERSION.SdkInt >= BuildVersionCodes.O && BroadcastHelper.CanResolveBroadcast(context, new Intent(Constants.DEFAULT_OREO_INTENT_ACTION)));
	}
}