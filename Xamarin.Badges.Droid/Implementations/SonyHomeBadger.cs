...
internal class SonyHomeBadger : IBadger
{
	...
	public string[] SupportedLaunchers => ["com.sonyericsson.home", "com.sonymobile.home"];
	 ...
	 */
	private bool ExecuteBadgeByContentProvider(Context context, ComponentName componentName, int badgeCount)
	{
		if (badgeCount < 0)
		{
			return false;
